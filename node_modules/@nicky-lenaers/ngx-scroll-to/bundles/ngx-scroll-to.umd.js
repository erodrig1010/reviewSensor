(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/platform-browser'), require('@angular/common'), require('rxjs/Observable'), require('rxjs/add/observable/throw'), require('rxjs/ReplaySubject')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/platform-browser', '@angular/common', 'rxjs/Observable', 'rxjs/add/observable/throw', 'rxjs/ReplaySubject'], factory) :
	(factory((global['ngx-scroll-to'] = {}),global.ng.core,global.ng.platformBrowser,global.ng.common,global.Rx,global.Rx.Observable,global.Rx));
}(this, (function (exports,core,platformBrowser,common,Observable,_throw,ReplaySubject) { 'use strict';
...
var ScrollToService = /** @class */ (function () {
    ...
    ScrollToService.prototype._start = function (options) {
        ...
        if (mergedConfigOptions.target && !targetNode)
            return Observable.Observable.throw('Unable to find Target Element');
        var /** @type {?} */ container = this._getContainer(mergedConfigOptions, targetNode);
        if (mergedConfigOptions.container && !container)
            return Observable.Observable.throw('Unable to find Container Element');
